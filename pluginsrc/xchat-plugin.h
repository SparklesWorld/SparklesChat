...
typedef struct ClientTab xchat_context;
...
struct _xchat_plugin
{
    ...
    // hexchat additions from here on
...
// edited to always define these, even on non-Windows
#if !defined(PLUGIN_C)
